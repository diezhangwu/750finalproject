...
models.r.table <- data.frame(type=c("Backward selection","Backward + Univariate Pre-screen",
                           ...
                           AIC=c(998.6967,1010.444,1022.898,1022.898,1042.574,1042.574), 
                           p=c(23,14,26,24,35,32),
...
colnames(errortable) <- c("Full model","Univariate pre-screen","Clinical Choice",
