...
=======
>>>>>>> 2b4db52ad3d3f229ef573835b692d83086e52ce2
```

```{r}
lasso.x.pred <- rowMeans(x.pred)
lasso.y.pred <- rowMeans(y.pred)
plot(lasso.x.pred, lasso.y.pred, type='s', 
     ylab=stats@y.name, xlab=stats@x.name, col='red', lwd=2, lty=2)
```
